...
define('game/playerinterface',['classy'], function(Class) {

	var Interface = Class.$extend({
		__init__ : function(controllerType) {
...
function(Class, Board, SeaWave, Jump, Wind, Bird, Controller) {
	...
	var Game = Class.$extend({
		__init__ : function(_canvas, callback) {
			...
			this.controller = new Controller('layout');
...
define('views/game',['backbone', 'tmpl/game', 'game/game', 'views/gameover'], 
	function(Backbone, gameTmpl, Game, gameOver) {
	...
	var View = Backbone.View.extend({
		...
		show : function() {
			...
			var self = this;
			this.$currButton.bind('click', function() {
